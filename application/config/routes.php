...
$route['addSchedule'] = 'admin/add_opp_schedule';
$route['updateSchedule'] = 'admin/update_opp_schedule';
$route['deleteSchedule'] = 'admin/delete_opp_schedule';
...
$route['activeOperation'] = 'admin/active_operations';
$route['schedulePreview/(:any)'] = 'admin/schedule_preview/$1';
